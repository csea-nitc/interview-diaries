...
export function Footer() {
    return (
        <footer className="w-full bg-primary-blue text-white px-6 py-10 md:px-12 md:py-12 shrink-0 flex flex-col md:flex-row justify-between items-center md:items-start font-mono gap-10 md:gap-0">
            {/* 1. Header */}
            <div className="flex flex-col order-1 md:order-1 items-center md:items-start w-full md:w-auto text-center md:text-left">
                <h1 className="text-5xl sm:text-5xl lg:text-6xl font-black tracking-widest leading-[0.9]">
            ...
            <div className="flex flex-col items-center md:items-start max-w-sm order-3 md:order-2 w-full md:w-auto">
                ...
                <div className="flex items-center justify-center gap-6 text-white w-full md:ml-10">
            ...
            <div className="flex flex-col order-2 md:order-3 w-full md:w-64 text-left">
                ...
                <ul className="space-y-4 text-base font-mono">
                    ...
                    <li><Link href="/" className="hover:underline">NIT Calict</Link></li>
                </ul>
            </div>
        </footer>
    );
